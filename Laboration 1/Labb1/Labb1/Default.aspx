...
<body>
    <div id="page">
        ...
        <div>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Textfältet får inte vara tomt." Display="Dynamic" ControlToValidate="TextArea1" CssClass="error" ></asp:RequiredFieldValidator>
